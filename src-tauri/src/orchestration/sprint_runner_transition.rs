...
impl SprintRunnerTransitionService {
    ...
    fn strict_sprint_result_context(&self,invocation:&AgentInvocationId)->Result<serde_json::Value,SprintRunnerTransitionError>{
        ...
        Ok(serde_json::json!({"sprintResult":{"kind":kind,"continuationKind":continuation,"structuredAttention":attention},"boundary":{"requestOrIntentIsNotDelivery":true,"noLaterSprintStartAvailable":true,"sprint":sprint}}))
    }

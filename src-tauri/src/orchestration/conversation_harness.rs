...
pub(crate) enum ConversationHarnessRole {
    ...
    EpicRunnerSprintResultReassessment,
    SprintRunner,
...
impl ConversationHarnessRole {
    fn key(self) -> &'static str {
        match self {
            ...
            Self::EpicRunnerSprintResultReassessment => "epic_runner_sprint_result_reassessment",
...
pub(crate) fn role_discovery_root(role: ConversationHarnessRole) -> Result<String, String> {
    ...
    let required_skill = match role {
        ...
        ConversationHarnessRole::EpicRunnerSprintResultReassessment => "epic-runner",

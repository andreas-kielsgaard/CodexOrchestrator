...
pub(crate) const RUNTIME_PROFILE_CONTRACT_VERSION: u32 = 1;
...
pub(crate) struct CapabilitySet {
    ...
    pub(crate) reasoning_modes: BTreeSet<String>,
    pub(crate) sandbox_modes: BTreeSet<SandboxMode>,
    pub(crate) mcp_tools: BTreeMap<String, BTreeSet<String>>,
    pub(crate) skills: BTreeSet<String>,
}

impl CapabilitySet {
    pub(crate) fn validate(&self, owner: &str) -> Result<(), String> {
    ...
    pub(crate) fn first_capability_outside(&self, available: &Self) -> Option<String> {
        self.models
...
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(crate) struct RuntimeSelections {
...
pub(crate) struct RuntimeProfileSnapshot {
    ...
    pub(crate) exposure: CapabilitySet,
...
pub(crate) fn validate_selection_availability(
...
pub(crate) fn validate_identifier(owner: &str, field: &str, value: &str) -> Result<(), String> {

...
pub(crate) struct WorktreeObservationId(String);
...
impl WorktreeObservationId {
    ...
    pub(crate) fn for_path(repository_id: &RepositoryId, path: &Path) -> Self {
...
pub(crate) struct WorktreeObservation {
    pub(crate) id: WorktreeObservationId,
...
#[derive(Clone)]
pub(crate) struct WorktreeInventoryReader {

use crate::execution_configuration::SelectedRuntimeProfileSource;
...
pub(crate) struct ProviderConfigurationRegistry {
    entries: HashMap<String, Arc<dyn SelectedRuntimeProfileSource>>,
}
...
impl ProviderConfigurationRegistry {
    ...
    pub(crate) fn source(
        &self,
        provider: &str,
    ) -> Result<Arc<dyn SelectedRuntimeProfileSource>, String> {

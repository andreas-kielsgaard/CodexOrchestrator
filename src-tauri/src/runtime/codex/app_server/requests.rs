...
use crate::agent_sessions::ports::{RuntimePortError, RuntimePortErrorKind};
...
pub(super) fn receive(invocation: &Invocation, message: Value) -> Result<(), RuntimePortError> {
    ...
    invocation.sink.emit_update(
        ...
        crate::agent_sessions::ports::RuntimeUpdate::Event(
            crate::agent_sessions::ports::RuntimeEventDraft {

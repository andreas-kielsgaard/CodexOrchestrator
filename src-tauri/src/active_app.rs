...
pub(crate) fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::agent_sessions::transport::target_transition::request_agent_session_target_transition,
            crate::agent_sessions::transport::target_transition::load_agent_session_target_transition,
            crate::agent_sessions::transport::target_transition::start_agent_session_target_transition,

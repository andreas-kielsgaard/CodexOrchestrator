...
const recordedSnapshot: EpicProductDecisionSnapshot = validateEpicProductDecisionSnapshot({
  ...
  evidence: [
    ...
    },
    {
      ...
      label: 'Recorded Epic Runner final response',
  ...
  decisions: [
    ...
    },
    {
      ...
      evidenceIds: ['evidence-agent-session-layout-passage', 'evidence-sprint-detail-completion'],
      lineage: { kind: 'introduced', supersedesDecisionIds: [] },
    },
  ],
  candidates: [
...
export const recordedEpicProductDecisionSource: EpicProductDecisionSource = {
  ...
  resolveEvidenceNavigation(request) {
    return resolveProductDecisionEvidenceNavigation(recordedSnapshot, request);
  },
};

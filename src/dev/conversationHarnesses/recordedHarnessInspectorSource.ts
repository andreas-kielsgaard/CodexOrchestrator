...
} from './recordedHarnessIdentityCatalog';
import type {
...
/** Injected recorded fixture only; no assignment or durable identity storage is implemented. */
...
export function createRecordedHarnessManagementSource(options?: {
  onSessionIdentityChange?(identity: AgentIdentity): void;
}): ConversationHarnessManagementSource {

...
export function isolatedEnvironment(source, manifest) {
  ...
  Object.assign(environment, {
    ...
    VITE_RUNTIME_INSTANCE_ID: manifest.identity.instanceId,
    VITE_RUNTIME_SESSION_ID: manifest.identity.sessionId,
    VITE_RUNTIME_WORKTREE_PATH: manifest.identity.worktreePath,
    VITE_RUNTIME_GIT_COMMIT: manifest.identity.gitCommit,
    VITE_RUNTIME_SOURCE_FINGERPRINT: manifest.identity.sourceFingerprint,
    VITE_RUNTIME_TAURI_IDENTIFIER: manifest.identity.tauriIdentifier,
    VITE_RUNTIME_ROOT: manifest.projected.paths.root,
    VITE_RUNTIME_DIST: manifest.projected.paths.dist,
    VITE_RUNTIME_CARGO_TARGET: manifest.projected.paths.cargoTarget,
    VITE_RUNTIME_APP_DATA: manifest.projected.paths.appData,
    VITE_RUNTIME_CREDENTIALS: manifest.projected.paths.credentials,
    VITE_RUNTIME_LOGS: manifest.projected.paths.logs,
    VITE_RUNTIME_NODE_CACHE_KEY: manifest.projected.caches.node.key,
    VITE_RUNTIME_NODE_CACHE_PATH: manifest.projected.caches.node.path,
    VITE_RUNTIME_RUST_CACHE_KEY: manifest.projected.caches.rust.key,
    VITE_RUNTIME_RUST_CACHE_PATH: manifest.projected.caches.rust.path,
    VITE_RUNTIME_RUST_CACHE_MODE: manifest.projected.caches.rust.mode,
    VITE_RUNTIME_VITE_PORT: String(manifest.projected.ports.vite),
    VITE_RUNTIME_STATUS_PORT: String(manifest.projected.ports.status),
    VITE_RUNTIME_BUILD_OBSERVED: String(Boolean(manifest.observed?.build)),
    VITE_RUNTIME_TESTS_OBSERVED: String(Boolean(manifest.observed?.tests)),

...
pub struct CodexCliCapabilities {
    ...
    pub exec_json: Option<bool>,
    pub resume_json: Option<bool>,
    pub exec_model: Option<bool>,
    pub resume_model: Option<bool>,
    pub exec_sandbox: Option<bool>,
    pub resume_sandbox: Option<bool>,
}
...
impl CodexCliCapabilityProbe {
    ...
    pub fn from_resolved(program: Result<String, String>) -> Self {
        Self { program }
    }

    pub fn discover(&self) -> CodexCliCapabilities {
        self.discover_raw().0
    }
...
pub struct FixedCodexCapabilityDiscovery {
    capabilities: CodexCliCapabilities,
}

impl FixedCodexCapabilityDiscovery {
    pub fn new(capabilities: CodexCliCapabilities) -> Self {
        Self { capabilities }
    }
}
...
pub fn resolve_program(program: String) -> Result<String, String> {
    #[cfg(windows)]
    {
        use std::path::Path;

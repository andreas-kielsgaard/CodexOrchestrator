...
description: Own one product Work Unit through implementation instantiation, review, correction, and integration. Use only when the application-owned Work Unit Handler Harness exposes this skill.
---
